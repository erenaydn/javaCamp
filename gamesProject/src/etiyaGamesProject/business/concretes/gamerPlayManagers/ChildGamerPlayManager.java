...
public class ChildGamerPlayManager implements GamerPlayService {

	public ChildGamerPlayManager() {
		super();
	}
	...
	public void levelUp(User user, Game game) {
		...
		user.setGamerPoint(user.getGamerPoint() + 100);

		System.out
				.println(user.getGamerPoint() + " : yeni puan bu sekildedir. Cocuk kullanici puanlamasý yansimistir.");
